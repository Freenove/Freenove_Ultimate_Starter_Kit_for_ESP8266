...
If you have not yet downloaded Micropython Firmware, click :ref:`here <Micropython>`.

If you have not yet loaded Micropython Firmware, click :ref:`here <loaded>`.
...
.. note::
    ...
    This is the code :ref:`running online<running_online>`. If you disconnect USB cable and repower ESP8266 or press its reset key, LED stops blinking and the following messages will be displayed in Thonny.
...
Codes here is run offline. If you want to stop :ref:`running online<offline>` and enter Shell, just click "Stop" in Thonny.
...
.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/01.2_Blink/Blink.py
    :linenos: 
    :language: python
    :lines: 1-12
    :dedent: